...
import { getPayFeesIn } from "../utils/configs";
import { IERC20, IERC20__factory } from "../typechain-types";
import { LINK_ADDRESSES, PayFeesIn } from "../utils/constants";
import { Spinner } from "../utils/spinner";


task(`fill-sender-v2`, `Transfers the provided amount of LINK token or native coin to the sender contract to serve for paying CCIP fees`)
